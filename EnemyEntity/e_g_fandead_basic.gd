...
func change_animation(code):
	...
	if code == "float":
		if animation_state == 1:
			$AnimatedSprite.play("float_1")
		if animation_state == 2:
			$AnimatedSprite.play("float_2")
		if animation_state == 3:
			$AnimatedSprite.play("float_3")
	if code == "damage":
		if animation_state == 1:
			$AnimatedSprite.play("damage_1")
		if animation_state == 2:
			$AnimatedSprite.play("damage_2")
		if animation_state == 3:
			$AnimatedSprite.play("damage_3")
